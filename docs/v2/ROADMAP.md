...
- [Phased Roadmap](#-phased-roadmap)
  ...
  - [Phase 2 – Managed Execution: APScheduler (Completed)](#phase-2--managed-execution-apscheduler-completed)
  ...
  - [Phase 7 – CI/CD Pipeline (Completed)](#phase-7--cicd-pipeline-completed)
...
| Area | Status before V2 (V1) |
|---|---|
| Infrastructure | ❌ No containerization — manual Python environment setup on the host |
...
- [x] Add `apscheduler` as a runtime dependency
- [x] Refactor `main.py` to replace the `while True` loop with an APScheduler entrypoint:
...
- [x] Implement retry logic around read-only API calls (balance, prices, and ATR)
...
Detailed execution plan: [`plans/phase-5-fastapi.md`](plans/phase-5-fastapi.md).
...
Detailed execution plan: [`plans/phase-6-code-quality.md`](plans/phase-6-code-quality.md).
...
Detailed execution plan: [`plans/phase-7-cicd.md`](plans/phase-7-cicd.md).
...
Detailed execution plan: [`plans/phase-8-grafana.md`](plans/phase-8-grafana.md).
...
- [x] **Roadmap & future work** — link to `ROADMAP.md`; explicitly point to `plans/phase-10-trading-tools-integration.md` as a designed-but-unimplemented extension
...
Detailed execution plan: [`plans/phase-9-project-documentation.md`](plans/phase-9-project-documentation.md).
...
Detailed execution plan: [`plans/phase-10-trading-tools-integration.md`](plans/phase-10-trading-tools-integration.md).
